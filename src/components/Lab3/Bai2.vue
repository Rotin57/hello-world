<template>
  <div>
    ...
    <div class="header-image">
      <img src="./img/hinh-nen-sieu-xe-33.jpg" class="w-100" alt="Header image">
    </div>
    ...
    <section class="container my-5">
      <div class="row">
        ...
        <!-- Về Tôi (About Me) Section -->
        <div class="col-md-4">
          <h2 class="text-info mb-3">Về Tôi</h2>
          <div class="card">
            <div class="card-body text-center">
              <img src="../Lab3/img/avatar.png" alt="Avatar" class="avatar">
              <h5 class="card-title mt-3">Giới Thiệu Bản Thân</h5>
              <p class="card-text">
                SV. :> <br> 
                <strong>Châm Ngôn:</strong> Ăn cơm thì nhớ húp canh
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-8">
          ...
          <div class="card mb-3">
            <img src="../Lab3/img/tap-piltes.jpg" class="card-img-top" alt="Blog image">
            <div class="card-body">
          ...
          <div class="related-articles">
            <div class="d-flex align-items-start mb-3">
              <img src="../Lab3/img/corevalue.jpg" alt="Article image" width="20%" class="rounded mr-3">
              <div>
            ...
            <div class="d-flex align-items-start mb-3">
              <img src="../Lab3/img/tim-mach.jpg" width="20%" alt="Dầu dừa" class="rounded mr-3">
              <div>
                <p class="mb-1 font-weight-bold">10 công dụng bất ngờ từ dầu dừa</p>
              </div>
            </div>
            <div class="d-flex align-items-start">
              <img src="../Lab3/img/spinach_300x300.jpg" width="20%" alt="Rau mỗi ngày" class="rounded mr-3">
              <div>
      ...
      <div class="row mt-5">
        <div class="col-12">
          <h2 class="text-info mb-3 text-center">VIDEO - ĐỪNG BỎ LỠ</h2>
          <div class="row">
            <!-- Video Cards -->
            <div class="col-md-4">
              <div class="card mb-3">
